  ...
  const accordionSections = [
    {
      ...
      data: [
        { url: "https://preconetindia.com/refund.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/privacy.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/reviews.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/chatbot.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/digital-marketing.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/cloud.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/contact.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/cyber-security.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/mobile-app-dev.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/industries.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/ui-ux.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/about.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/assets/brochure.pdf", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/terms.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/index.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." },
        { url: "https://preconetindia.com/web-development.html", desc: "Orphan page detected. Present in sitemap but has no internal incoming links from this page." }
      ]
    },
    {
      id: "few-links",
      title: "Pages with Few Internal Links",
      count: 6,
      badgeColor: "bg-amber-500",
      icon: Hash,
      iconColor: "text-amber-500",
      data: [
        { url: "tel:+918282823825", desc: "Page is only linked once from the audited page, limiting search indexing visibility. (Incoming link count: 1)" },
        { url: "tel:+918282823826", desc: "Page is only linked once from the audited page, limiting search indexing visibility. (Incoming link count: 1)" },
        { url: "https://preconetindia.com/career.html", desc: "Page is only linked once from the audited page, limiting search indexing visibility. (Incoming link count: 1)" },
        { url: "https://preconetindia.com/terms", desc: "Page is only linked once from the audited page, limiting search indexing visibility. (Incoming link count: 1)" },
        { url: "https://preconetindia.com/privacy", desc: "Page is only linked once from the audited page, limiting search indexing visibility. (Incoming link count: 1)" },
        { url: "https://preconetindia.com/refund", desc: "Page is only linked once from the audited page, limiting search indexing visibility. (Incoming link count: 1)" }
      ]
    },
    {
      id: "weak-anchors",
      title: "Weak Anchor Texts",
      count: 1,
      badgeColor: "bg-amber-500",
      icon: Anchor,
      iconColor: "text-amber-500",
      data: [
        {
          from: "/",
          url: "https://www.google.com/search?q=GB-47, Rajdanga main road, Kolkata - 700107. (Near GST Bhawan)",
          anchor: "[empty]",
          desc: "Anchor text is completely empty (no clickable text or alt description)."
        }
      ]
    },
    {
      id: "duplicate-anchors",
      title: "Duplicate Anchor Texts",
      count: 0,
